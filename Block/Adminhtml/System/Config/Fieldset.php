...
namespace Banchile\Payments\Block\Adminhtml\System\Config;
...
class Fieldset extends BaseField
{
    ...
    public function _getHeaderTitleHtml($element)
    {
        ...
        $html .= '<div class="button-container"><button type="button" ' .
            ...
            (empty($groupConfig['banchile_ec_separate']) ? '' : ' banchile-ec-separate') .
            '" id="' .
            $htmlId .
            '-head" onclick="banchileToggleSolution.call(this, \'' .
            $htmlId .
            "', '" .
            $this->getUrl(
                'adminhtml/*/state'
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.banchileToggleSolution = function (id, url) {
                var doScroll = false;
